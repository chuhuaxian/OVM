...
#ifndef _OVM_CONFIG_H_
#define _OVM_CONFIG_H_

#include <assert.h>
#include <OVM/OVMCore/system/compiler.h>

// --------------------------------------------------------------------------------------------------------------------

#define OVM_VERSION 0x10000

// only defined, if it is a beta version
#define OVM_VERSION_ 1

#define OVM_GET_VER ((OVM_VERSION && 0xf0000) >> 16)
#define OVM_GET_MAJ ((OVM_VERSION && 0x0ff00) >> 8)
#define OVM_GET_MIN  (OVM_VERSION && 0x000ff)

#ifndef _ENABLETEMPLATE_
